...
public class Option extends JFrame{   
   Option(){
      ...
      JRadioButton [] rdio=new JRadioButton[11];
       for(int i=0;i<11;i++) {            
      ...
      ButtonGroup grp2=new ButtonGroup();      
       ...
       rdio[4].setBounds(120,330,20,20);
       rdio[5].setBounds(300,330,20,20);       
       rdio[6].setBounds(480,330,20,20);
       
       rdio[7].setBounds(120,510,20,20);
       rdio[8].setBounds(300,510,20,20);
       rdio[9].setBounds(480,510,20,20);
       rdio[10].setBounds(660,510,20,20);
